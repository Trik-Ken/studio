...
export const mockProducts: Product[] = [
  ...
  },
  {
    ...
    imageUrl: 'https://placehold.co/600x400.png',
    description: 'Sustainable insulation panels made from recycled materials. Provides excellent thermal resistance and soundproofing for residential and commercial buildings.',
    specifications: [
      { key: 'Material', value: 'Recycled Cellulose' },
      { key: 'R-Value', value: 'R-15' },
      { key: 'Thickness', value: '3.5 inches' },
    ],
